			...
			if (state === "SUCCESS") {
                ...
                if(jSonParse != null){ 
                    ...
                    if(nameservice.includes('querySF')){
                        ...
                        component.set('v.displayColumns', columnsFinal);
                        ...
                        dataFinal = '[' + dataFinal + ']';
                        var parsedData = JSON.parse(dataFinal);
                        component.set('v.dataTableData', parsedData);
                        component.set('v.originalData', parsedData);
                        component.set('v.displayData', parsedData);  
                    }else{
                        component.set('v.dataTableColumns',JSON.parse(responseData.columns));
                        component.set('v.displayColumns', JSON.parse(responseData.columns));
                        component.set('v.originalData', jSonParse);
                        component.set('v.displayData', jSonParse);
